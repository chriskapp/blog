...
namespace Chriskapp\Blog\Table\Generated;

/**
 * @extends \PSX\Sql\TableAbstract<\Chriskapp\Blog\Table\Generated\BlogRow>
 */
class BlogTable extends \PSX\Sql\TableAbstract
{
    ...
    /**
     * @return array<\Chriskapp\Blog\Table\Generated\BlogRow>
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findOneBy(\PSX\Sql\Condition $condition) : ?\Chriskapp\Blog\Table\Generated\BlogRow
    {
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function find(string $id) : ?\Chriskapp\Blog\Table\Generated\BlogRow
    {
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findOneById(string $value) : ?\Chriskapp\Blog\Table\Generated\BlogRow
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('id', $value);
        return $this->doFindOneBy($condition);
     ...
     */
    public function updateById(string $value, \Chriskapp\Blog\Table\Generated\BlogRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('id', $value);
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findOneByTitle(string $value) : ?\Chriskapp\Blog\Table\Generated\BlogRow
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('title', $value);
        return $this->doFindOneBy($condition);
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByTitle(string $value, \Chriskapp\Blog\Table\Generated\BlogRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('title', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findOneByTitleSlug(string $value) : ?\Chriskapp\Blog\Table\Generated\BlogRow
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('title_slug', $value);
        return $this->doFindOneBy($condition);
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByTitleSlug(string $value, \Chriskapp\Blog\Table\Generated\BlogRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('title_slug', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findOneByAuthorName(string $value) : ?\Chriskapp\Blog\Table\Generated\BlogRow
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('author_name', $value);
        return $this->doFindOneBy($condition);
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByAuthorName(string $value, \Chriskapp\Blog\Table\Generated\BlogRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('author_name', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findOneByAuthorUri(string $value) : ?\Chriskapp\Blog\Table\Generated\BlogRow
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('author_uri', $value);
        return $this->doFindOneBy($condition);
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByAuthorUri(string $value, \Chriskapp\Blog\Table\Generated\BlogRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('author_uri', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findOneByUpdated(\PSX\DateTime\LocalDateTime $value) : ?\Chriskapp\Blog\Table\Generated\BlogRow
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->equals('updated', $value);
        return $this->doFindOneBy($condition);
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByUpdated(\PSX\DateTime\LocalDateTime $value, \Chriskapp\Blog\Table\Generated\BlogRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->equals('updated', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findOneBySummary(string $value) : ?\Chriskapp\Blog\Table\Generated\BlogRow
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('summary', $value);
        return $this->doFindOneBy($condition);
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateBySummary(string $value, \Chriskapp\Blog\Table\Generated\BlogRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('summary', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findOneByCategory(string $value) : ?\Chriskapp\Blog\Table\Generated\BlogRow
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('category', $value);
        return $this->doFindOneBy($condition);
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByCategory(string $value, \Chriskapp\Blog\Table\Generated\BlogRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('category', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findOneByContent(string $value) : ?\Chriskapp\Blog\Table\Generated\BlogRow
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('content', $value);
        return $this->doFindOneBy($condition);
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByContent(string $value, \Chriskapp\Blog\Table\Generated\BlogRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('content', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function create(\Chriskapp\Blog\Table\Generated\BlogRow $record) : int
    {
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function update(\Chriskapp\Blog\Table\Generated\BlogRow $record) : int
    {
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateBy(\PSX\Sql\Condition $condition, \Chriskapp\Blog\Table\Generated\BlogRow $record) : int
    {
        return $this->doUpdateBy($condition, $record->toRecord());
    }
    /**
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function delete(\Chriskapp\Blog\Table\Generated\BlogRow $record) : int
    {
     ...
     */
    protected function newRecord(array $row) : \Chriskapp\Blog\Table\Generated\BlogRow
    {
        return \Chriskapp\Blog\Table\Generated\BlogRow::from($row);
    }
}